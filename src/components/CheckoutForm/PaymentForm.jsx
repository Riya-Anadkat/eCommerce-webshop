...
// const PaymentForm = ({ checkoutToken, backStep, onCaptureCheckout, nextStep, customerData }) => {
...
//                 // checkoutToken.extrafield.name: customerData.extrafield.name
//             //    order:{checkoutToken.extrafields.name: customerData.extrafields.name},
              
//             //    checkoutToken.extrafields.map((extrafield) => (
//             //     extrafield.name: customerData.extrafield.name,
//             //     )) 
